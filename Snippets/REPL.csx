...
#if NET8_0_OR_GREATER
        new(memory, BreakingSearch);
#else
        new(memory, Breaking.AsMemory(), true);
#endif
...
#if NET8_0_OR_GREATER
        new(memory, UnicodeSearch);
#else
        new(memory, Unicode.AsMemory(), true);
#endif
