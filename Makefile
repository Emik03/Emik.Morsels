...
repl: Snippets/REPL.csx
	...
	csharprepl -r "nuget: CommunityToolkit.Common, 8.2.2" "nuget: CommunityToolkit.Diagnostics, 8.2.2" "nuget: CommunityToolkit.HighPerformance, 8.2.2" "nuget: Emik.Results, 2.1.1" "nuget: FastGenericNew, 3.1.0-preview1" "nuget: JetBrains.Annotations, 2023.3.0" "nuget: TextCopy, 6.2.1" "$(realpath Snippets/REPL.csx)"
