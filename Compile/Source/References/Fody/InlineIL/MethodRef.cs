...
sealed class MethodRef
{
    ...
    public MethodRef(TypeRef type, string methodName) => IL.Throw();
    ...
    /// </remarks>
    public MethodRef(TypeRef type, string methodName, params TypeRef[] parameterTypes) => IL.Throw();
    ...
    /// <param name="type">The type declaring the method.</param>
    /// <param name="methodName">The method name.</param>
    public static MethodRef Method(TypeRef type, string methodName) => throw IL.Throw();
    ...
    /// from the <see cref="TypeRef"/> class to represent generic parameter types.
    /// </remarks>
    public static MethodRef Method(
        TypeRef type,
        string methodName,
        int genericParameterCount,
        params TypeRef[] parameterTypes
    ...
    public static MethodRef PropertyGet(TypeRef type, string propertyName) => throw IL.Throw();
    ...
    /// <param name="type">The type declaring the property.</param>
    /// <param name="propertyName">The property name.</param>
    public static MethodRef PropertySet(TypeRef type, string propertyName) => throw IL.Throw();
    ...
    public static MethodRef EventAdd(TypeRef type, string eventName) => throw IL.Throw();
    ...
    /// <param name="type">The type declaring the event.</param>
    /// <param name="eventName">The event name.</param>
    public static MethodRef EventRemove(TypeRef type, string eventName) => throw IL.Throw();
    ...
    /// <param name="type">The type declaring the event.</param>
    /// <param name="eventName">The event name.</param>
    public static MethodRef EventRaise(TypeRef type, string eventName) => throw IL.Throw();
    ...
    /// from the <see cref="TypeRef"/> class to represent generic parameter types.
    /// </remarks>
    public static MethodRef Constructor(TypeRef type, params TypeRef[] parameterTypes) => throw IL.Throw();

    /// <summary>
    /// Constructs a method reference to a type initializer (<c>.cctor</c> method).
    /// </summary>
    /// <param name="type">The type declaring the constructor.</param>
    public static MethodRef TypeInitializer(TypeRef type) => throw IL.Throw();
    ...
    public static MethodRef Operator(TypeRef type, UnaryOperator @operator) => throw IL.Throw();
    ...
    public static MethodRef Operator(
        TypeRef type,
    ...
    public MethodRef MakeGenericMethod(params TypeRef[] genericParameterTypes) => throw IL.Throw();
    ...
    public MethodRef WithOptionalParameters(params TypeRef[] optionalParameterTypes) => throw IL.Throw();
}
#endif
