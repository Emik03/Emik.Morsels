...
/// <summary>
/// Injects IL code to the calling method, using InlineIL.Fody. All method calls are replaced at weaving time.
/// </summary>
[SuppressMessage("ReSharper", "UnusedParameter.Global")]
static unsafe partial class IL
{
    /// <summary>
    ...
    public static void DeclareLocals(params LocalVar[] locals) => Throw();
    ...
    /// <param name="locals">The list of local variable declarations.</param>
    public static void DeclareLocals(bool init, params LocalVar[] locals) => Throw();

    /// <summary>
    /// Marks the current code position with the given label.
    /// </summary>
    /// <param name="labelName">The label name.</param>
    public static void MarkLabel(string labelName) => Throw();
    ...
    public static void Push<T>(T? value) => Throw();
    ...
    /// <typeparam name="T">The reference target type.</typeparam>
    /// <param name="value">The reference to push.</param>
    public static void PushInRef<T>(ref readonly T? value) => Throw();
    ...
    /// <typeparam name="T">The reference target type.</typeparam>
    /// <param name="value">The reference to push.</param>
    public static void PushOutRef<T>(out T value) => throw Throw();
    ...
    public static void Pop<T>(out T value) => throw Throw();
    ...
    /// </summary>
    /// <param name="value">A reference to a local variable receiving the pointer.</param>
    public static void Pop(out void* value) => throw Throw();
    ...
    public static Exception Unreachable() => throw Throw();
    ...
    public static T Return<T>() => throw Throw();
    ...
    public static ref T ReturnRef<T>() => throw Throw();
    ...
    /// </remarks>
    /// <returns>The pointer on top of the evaluation stack, which should be immediately returned from the method.</returns>
    public static void* ReturnPointer() => throw Throw();
    ...
    public static void EnsureLocal<T>(in T? value) => throw Throw();

    internal static Exception Throw() =>
        throw new InvalidOperationException(
            "This method is meant to be replaced at compile time by InlineIL.Fody, but the weaver has not been executed correctly."
        );
}
#endif
