...
sealed class TypeRef
{
    ...
    /// </summary>
    public static string CoreLibrary => throw IL.Throw();
    ...
    /// </remarks>
    public static GenericParameters TypeGenericParameters => throw IL.Throw();

    /// <summary>
    /// Generic parameters of the method, for overload resolution in <see cref="MethodRef"/>.
    /// </summary>
    public static GenericParameters MethodGenericParameters => throw IL.Throw();

    /// <summary>
    /// Constructs a type reference from a <see cref="System.Type"/>.
    /// </summary>
    /// <param name="type">The type to reference.</param>
    public static TypeRef Type(Type type) => throw IL.Throw();

    /// <summary>
    /// Constructs a type reference from a <see cref="System.Type"/>.
    /// </summary>
    /// <typeparam name="T">The type to reference.</typeparam>
    public static TypeRef Type<T>() => throw IL.Throw();
    ...
    public TypeRef(Type type) => IL.Throw();
    ...
    public TypeRef(string assemblyName, string typeName) => IL.Throw();

    /// <summary>
    /// Converts a <see cref="System.Type"/> to a <see cref="TypeRef"/>.
    /// </summary>
    /// <param name="type">The type to reference.</param>
    public static implicit operator TypeRef(Type type) => throw IL.Throw();
    ...
    public TypeRef MakePointerType() => throw IL.Throw();
    ...
    public TypeRef MakeByRefType() => throw IL.Throw();
    ...
    public TypeRef MakeArrayType() => throw IL.Throw();
    ...
    public TypeRef MakeArrayType(int rank) => throw IL.Throw();
    ...
    public TypeRef MakeGenericType(params TypeRef[] typeArguments) => throw IL.Throw();
    ...
    public TypeRef WithOptionalModifier(TypeRef modifierType) => throw IL.Throw();
    ...
    /// <param name="modifierType">The custom modifier type.</param>
    /// <returns>A <see cref="TypeRef"/> with the custom modifier applied.</returns>
    public TypeRef WithRequiredModifier(TypeRef modifierType) => throw IL.Throw();
    ...
    public static TypeRef FromDllFile(string assemblyPath, string typeName) => throw IL.Throw();
    ...
    /// </remarks>
    [Obsolete("This is an experimental API. Use it at your own risk inside a #pragma warning disable CS0618 block.")]
    public static TypeRef FromDllFile(string assemblyPath, Type type) => throw IL.Throw();
}
#endif
