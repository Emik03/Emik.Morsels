...
namespace System.Runtime.InteropServices
{
    ...
    /// </summary>
    /// <remarks><para><example><para>Example of a valid use case. The Win32 `GetTickCount()` function is a small performance related function
    /// that reads some global memory and returns the value. In this case, the GC transition overhead is significantly
    /// more than the memory read.</para>
    /// <code>
    /// class Program
    /// {
    ///     [DllImport("Kernel32"), SuppressGCTransition]
    ///     static extern int GetTickCount();
    ///     static void Main() => Console.WriteLine($"{GetTickCount()}");
    /// }
    ...
    /// </description></item>
    /// <item><description>Native function does not throw exceptions.</description></item>
    /// <item><description>Native function does not manipulate locks or other concurrency primitives.</description></item>
    /// </list><para>
    /// Consequences of invalid uses of this attribute:
    /// </para><list type="bullet">
    /// <item><description>GC starvation.</description></item>
    /// <item><description>Immediate runtime termination.</description></item>
    /// <item><description>Data corruption.</description></item>
    /// </list>
    /// </remarks>
    [AttributeUsage(AttributeTargets.Method, Inherited = false)]
