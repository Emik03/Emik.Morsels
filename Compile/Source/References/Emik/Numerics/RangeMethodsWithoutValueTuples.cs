...
static partial class RangeMethodsWithoutValueTuples
{
    ...
    extension(Range range)
    {
        ...
        public void GetOffsetAndLength(int length, out int outOffset, out int outLength)
        {
        ...
        public bool TryGetOffsetAndLength(int length, out int outOffset, out int outLength)
        {
